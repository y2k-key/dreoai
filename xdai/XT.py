...
class xdai:
    ...
    async def inference(
        ...
        **kwargs,
        ...
        """
        Run inference on the xdai agent
    ...
    async def convert_to_model(
        ...
        **kwargs,
        ...
        """
        Converts a string to a Pydantic model using an xdai agent.
        ...
        **kwargs: Additional arguments to pass to the xdai agent as prompt arguments.
        """
