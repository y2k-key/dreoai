...
class RotationProvider:
    """
    The xdai provider rotates between available providers to handle requested based on token limits.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.agent_name = kwargs.get("agent_name", "xdai")
    ...
    async def inference(
        ...
        excluded_providers = {"xdai", "rotation", "gpt4free", "default"}
