...
app = FastAPI(
    title="xdai",
    description="xdai is an Artificial Intelligence Automation platform for creating and managing AI agents. Visit the GitHub repo for more information or to report issues. https://github.com/jaymes081/xdai/",
    version=version,
    docs_url="/",
    lifespan=lifespan,
)
