...
def fine_tune_llm(
    ...
    agent_settings = futr.agent_settings
    ...
    response = futr.create_dataset_from_memories(
    ...
    futr.agent_interactions.agent.update_agent_config(
