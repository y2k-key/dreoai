...
class futr:
    ...
    async def inference(
        ...
        **kwargs,
        ...
        """
        Run inference on the futr agent
    ...
    async def convert_to_model(
        ...
        **kwargs,
        ...
        """
        Converts a string to a Pydantic model using an futr agent.
        ...
        **kwargs: Additional arguments to pass to the futr agent as prompt arguments.
        """
