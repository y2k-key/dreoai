...
class RotationProvider:
    """
    The futr provider rotates between available providers to handle requested based on token limits.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.agent_name = kwargs.get("agent_name", "futr")
    ...
    async def inference(
        ...
        excluded_providers = {"futr", "rotation", "gpt4free", "default"}
