...
class RotationProvider:
    """
    The goai provider rotates between available providers to handle requested based on token limits.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.agent_name = kwargs.get("agent_name", "goai")
    ...
    async def inference(
        ...
        excluded_providers = {"goai", "rotation", "gpt4free", "default"}
