...
class goai:
    ...
    async def inference(
        ...
        **kwargs,
        ...
        """
        Run inference on the goai agent
    ...
    async def convert_to_model(
        ...
        **kwargs,
        ...
        """
        Converts a string to a Pydantic model using an goai agent.
        ...
        **kwargs: Additional arguments to pass to the goai agent as prompt arguments.
        """
