...
Extensions are the way to extend the functionality of uma with other software APIs or Python modules. Extensions are Python files that are placed in the `extensions` folder. uma will automatically load all extensions and commands associated when it starts.
