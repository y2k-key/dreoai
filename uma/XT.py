...
class uma:
    ...
    async def inference(
        ...
        **kwargs,
        ...
        """
        Run inference on the uma agent
    ...
    async def convert_to_model(
        ...
        **kwargs,
        ...
        """
        Converts a string to a Pydantic model using an uma agent.
        ...
        **kwargs: Additional arguments to pass to the uma agent as prompt arguments.
        """
