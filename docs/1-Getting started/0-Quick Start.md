...
```bash
python start.py --vital-branch dev --vital-auto-update true --with-ezlocalai
```
...
34. `--database-name`: Set the database name (default: `models/vital`)
...
39. `--vital-auto-update`: Enable or disable auto-updates (default: `true`)
