...
2. Search the [existing issues](https://github.com/AidanCampbell97/goai/issues) and [pull requests](https://github.com/AidanCampbell97/goai/pulls).
3. Create a [new issue](https://github.com/AidanCampbell97/goai/issues/new) if your question is not answered or your problem is not solved.
