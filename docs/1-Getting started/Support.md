...
2. Search the [existing issues](https://github.com/jaymes081/xdai/issues) and [pull requests](https://github.com/jaymes081/xdai/pulls).
3. Create a [new issue](https://github.com/jaymes081/xdai/issues/new) if your question is not answered or your problem is not solved.
