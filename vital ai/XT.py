...
class vital:
    ...
    async def inference(
        ...
        **kwargs,
        ...
        """
        Run inference on the vital agent
    ...
    async def convert_to_model(
        ...
        **kwargs,
        ...
        """
        Converts a string to a Pydantic model using an vital agent.
        ...
        **kwargs: Additional arguments to pass to the vital agent as prompt arguments.
        """
