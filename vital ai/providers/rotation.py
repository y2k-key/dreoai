...
class RotationProvider:
    """
    The vital provider rotates between available providers to handle requested based on token limits.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.agent_name = kwargs.get("agent_name", "vital")
    ...
    async def inference(
        ...
        excluded_providers = {"vital", "rotation", "gpt4free", "default"}
