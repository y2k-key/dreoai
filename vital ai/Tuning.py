...
def fine_tune_llm(
    ...
    agent_settings = vital.agent_settings
    ...
    response = vital.create_dataset_from_memories(
    ...
    vital.agent_interactions.agent.update_agent_config(
